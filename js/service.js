...
(function () {
  ...
  function renderCounts() {
    ...
    qs("#svcPendingCount") && (qs("#svcPendingCount").textContent = pending);
    qs("#svcCompletedCount") && (qs("#svcCompletedCount").textContent = completed);
    qs("#svcTotalProfit") && (qs("#svcTotalProfit").textContent = "₹" + profit);
  }
